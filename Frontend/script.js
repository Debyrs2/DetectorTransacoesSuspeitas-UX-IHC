...
const i18n = {
    pt: {
        ...
        loginSysDesc: "<span style='color: #ffffff; font-weight: 800;'>Plataforma inteligente de Detecção de Transações Suspeitas.<br><br>Proteja os seus ativos e garanta a integridade financeira com a nossa análise avançada de anomalias.",
    ...
    en: {
        ...
        loginSysDesc: "<span style='color: #ffffff; font-weight: 800;'>Intelligent Suspicious Transaction Detection platform.<br><br>Protect your assets and ensure financial integrity with our advanced anomaly analysis.",
    ...
    es: {
        ...
        loginSysDesc: "<span style='color: #ffffff; font-weight: 800;'>Plataforma inteligente de Detección de Transacciones Sospechosas.<br><br>Proteja sus activos y garantice la integridad financiera con nuestro análisis avanzado de anomalías.",
        themeLight: "Tema Claro",
